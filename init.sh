...
curl -sfL https://get.k3s.io | INSTALL_K3S_EXEC="--flannel-backend=none   --cluster-domain k3s.littleobi.com --disable-network-policy --cluster-cidr=192.168.0.0/16" sh -
